...
use App\Clases\ApiResponseHelper;
...
class StudentController extends Controller
{
    ...
    public function store(StoreStudentRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return ApiResponseHelper::sendResponse(new StudentResource($student), 'Student created', 201);
        } catch (\Exception $ex) {
            DB::rollBack();
    ...
    public function destroy(string $id)
    {
        ...
        return ApiResponseHelper::sendResponse(null, 'Record deleted', 200);
    }
}
